...
function academy_scripts()
{
	...
	wp_enqueue_script('academy-navigation', get_template_directory_uri() . '/js/academy_nav.js', array('jquery'), _S_VERSION, true);
...
/**
 * 
 * dislay theme information on admin dashboard
 */
...
function academy_change_footer()
{
	...
	$authorurl = get_option('authorurl', 'defualt_value');
