    ...
    $info = array(
        ...
        'getting_started' => array(
            ...
            'two' => array(
                ...
                'description' => esc_html__('To achieve custom home page other blog listing,you need to create and set static front page & assign "Home" template from page attributes.', 'academy'),
            ...
            'four' => array(
                ...
                'description' => esc_html__('Theme uses Widgets API options,using the widgets you can easily customize different aspects of the theme.', 'academy'),
